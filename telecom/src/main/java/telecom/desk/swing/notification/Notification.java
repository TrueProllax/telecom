package telecom.desk.swing.notification;
...
public class Notification extends javax.swing.JComponent {
    ...
    private LocationNotify location;

    public Notification(Frame fram, TypeNotify type, LocationNotify location, String message) {
        this.fram = fram;
        this.type = type;
    ...
    private void init(String message) {
        ...
        if (type == TypeNotify.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/notification/sucess.png")));
            lbMessage.setText("Success");
        } else if (type == TypeNotify.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/notification/info.png")));
            lbMessage.setText("Info");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/notification/warning.png")));
        ...
        TimingTarget target = new TimingTargetAdapter() {
            ...
            public void begin() {
                if (!showing) {
                    ...
                    int margin = 10;
                    int y = 0;
                    if (location == LocationNotify.TOP_CENTER) {
                        x = fram.getX() + ((fram.getWidth() - dialog.getWidth()) / 2);
                        y = fram.getY();
                        top_to_bot = true;
                    } else if (location == LocationNotify.TOP_RIGHT) {
                        x = fram.getX() + fram.getWidth() - dialog.getWidth() - margin;
                        y = fram.getY();
                        top_to_bot = true;
                    } else if (location == LocationNotify.TOP_LEFT) {
                        x = fram.getX() + margin;
                        y = fram.getY();
                        top_to_bot = true;
                    } else if (location == LocationNotify.BOTTOM_CENTER) {
                        x = fram.getX() + ((fram.getWidth() - dialog.getWidth()) / 2);
                        y = fram.getY() + fram.getHeight() - dialog.getHeight();
                        top_to_bot = false;
                    } else if (location == LocationNotify.BOTTOM_RIGHT) {
                        x = fram.getX() + fram.getWidth() - dialog.getWidth() - margin;
                        y = fram.getY() + fram.getHeight() - dialog.getHeight();
                        top_to_bot = false;
                    } else if (location == LocationNotify.BOTTOM_LEFT) {
                        x = fram.getX() + margin;
                        y = fram.getY() + fram.getHeight() - dialog.getHeight();
                        top_to_bot = false;
                    } else {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(320, 64));
        setPreferredSize(new java.awt.Dimension(320, 64));

        lbIcon.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/notification/sucess.png"))); // NOI18N

        panel.setOpaque(false);
        panel.setPreferredSize(new java.awt.Dimension(220, 64));

        lbMessage.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        lbMessage.setForeground(new java.awt.Color(51, 51, 51));
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/notification/close.png"))); // NOI18N
    ...
    public static enum LocationNotify {
