...
public class LButton extends JButton {
    ...
    protected boolean borderLineLeftAdd = false;
    ...
    protected void paintComponent(Graphics g) {
        ...
        int wText = fm.stringWidth(getText());

        graphics.setColor(getForeground());
        graphics.drawString(getText(), ((getWidth() - shadowGap) - wText) / 2, ((getHeight() - shadowGap) + getFont().getSize()) / 2);
