    ...
    protected void paintComponent(Graphics grphcs) {
        if (type != null) {
            ...
            if (type == StatusType.ACTIVE) {
                g = new GradientPaint(0, 0, new Color(73, 184, 65), 0, getHeight(), new Color(72, 169, 169));
            } else if (type == StatusType.INACTIVE) {
                g = new GradientPaint(0, 0, new Color(213, 107, 108), 0, getHeight(), new Color(255, 102, 102));
            } else {
